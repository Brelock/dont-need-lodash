...
# Вам не (возможно) не нужен Lodash / Underscore [! [Присоединяйтесь к сообществу на Spectrum] (https://withspectrum.github.io/badge/badge.svg)] (https://spectrum.chat/you-dont-need/lodash-underscore) [! [Gitter] (https://badges.gitter.im/Join Chat.svg)] (https://gitter.im/cht8687/You-Dont-Need-Lodash-Underscore) Lodash и Underscore - отличные современные служебные библиотеки JavaScript, которые широко используются Front-end разработчиками. Однако, когда вы ориентируетесь на современные браузеры, вы можете обнаружить, что существует множество методов, которые уже изначально поддерживаются благодаря ECMAScript5 [ES5] и ECMAScript2015 [ES6]. Если вы хотите, чтобы для вашего проекта требовалось меньше зависимостей, и вы четко знаете свой целевой браузер, то вам может не понадобиться Lodash / Underscore. Вы можете внести свой вклад, добавив больше элементов, представленных ниже. * Если вы ориентируетесь на устаревший движок JavaScript с этими методами ES5, вы можете использовать [es5-shim] (https://github.com/es-shims/es5-shim) * Обратите внимание, что приведенные ниже примеры просто показывают вам альтернативный вариант выполнения определенных задач. Для некоторых функций Lodash предоставляет больше возможностей, чем собственные встроенные модули. Этот список не является сравнением 1: 1. * Пожалуйста, отправьте PR, если вы хотите добавить или изменить код. Нет необходимости открывать проблему, если только это не что-то важное и вы хотите обсудить. ## Голос разработчиков > [Используйте встроенные утилиты объектов и массивов JavaScript, прежде чем добиваться больших успехов.] (Https://twitter.com/codylindley/status/692356631007342593) >